...
def mapperRequest(ind,success_count):
    try:
        with grpc.insecure_channel(Mappers[ind].ip) as channel:
            ...
            request = Kmeans_pb2.MasterToMapperReq(mapper_index=ind+1,start_index=IndicesAssigned[ind][0],end_index=IndicesAssigned[ind][1],prev_Centroids=Centroid,reducer_count=R)
